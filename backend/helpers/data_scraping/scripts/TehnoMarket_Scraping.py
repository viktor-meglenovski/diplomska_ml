...
def scrape_data(folder_path):
    ...
    all_products=list()
    load_products(driver, all_products, 'https://tehnomarket.com.mk/category/4003/laptopi#page/{i}/offset/64/', 'LAPTOP')
    load_products(driver, all_products, 'https://tehnomarket.com.mk/category/4109/mobilni-telefoni#page/{i}/offset/64/', 'PHONE', price_lower_bound_threshold=3000)
